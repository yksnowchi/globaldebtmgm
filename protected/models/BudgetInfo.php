 ...
 * @property double $monthly_car_payments
...
class BudgetInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('monthly_income, monthly_car_payments, monthly_utilites, monthly_grocery_expenses, monthly_insurance_payments, rrsp, food_stamp_or_other, spouse_monthly_takehome_pay, estimated_home_value, remaining_mortgage_balance, household_expenses, total_debt_to_income_perc, total_expenses_to_income_variance, mortgage, rent', 'numerical'),
			array('reason_for_hardship', 'length', 'max'=>255),
			array('updated_at', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, monthly_income, monthly_car_payments, monthly_utilites, monthly_grocery_expenses, monthly_insurance_payments, rrsp, food_stamp_or_other, spouse_monthly_takehome_pay, reason_for_hardship, estimated_home_value, remaining_mortgage_balance, total_number_dependants, household_expenses, total_debt_to_income_perc, total_expenses_to_income_variance, mortgage, rent, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'monthly_car_payments' => 'Monthly Car Payments',
	...
	public function search()
	{
		...
		$criteria->compare('monthly_car_payments',$this->monthly_car_payments);
